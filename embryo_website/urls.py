...
from embryo_website.views import home, lectures, contribute, gallery, newsletters, about, theteam, pilaniteam, faq, register, lecturedetail, searching, discipline, event, atmosdetail, atmos_list, aic, aic_track, company_details
